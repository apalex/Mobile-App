...
class UserSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text("Settings", style: TextStyle(letterSpacing: 1),),
          centerTitle: true,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Text("Language", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),)
                    ),
                    Container(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Text("Currency", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),)
                    ),
                    Container(
                      margin: EdgeInsets.only(right: MediaQuery.of(context).size.width * 0.05, top: MediaQuery.of(context).size.height * 0.03),
                      child: ButtonTheme(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.05, top: MediaQuery.of(context).size.height * 0.04),
                      child: const Text("Theme", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),)
                    ),
                    Container(
                      margin: EdgeInsets.only(right: MediaQuery.of(context).size.width * 0.05, top: MediaQuery.of(context).size.height * 0.03),
                      child: ButtonTheme(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: const Text("Logout", style: TextStyle(color: Colors.greenAccent, fontSize: 22),)
                      ),
                    ],
                  ),
                )
