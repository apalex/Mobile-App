...
class _UserSecurityState extends State<UserSecurity> {
  ...
  Future<void> confirmDeletion(BuildContext context) async {
    ...
    AlertDialog message = AlertDialog(
      title: const Text("Account Deletion", style: TextStyle(fontSize: 20),),
      content: const Text("Are you sure you want to delete your account? By pressing confirm you will not be able to restore your account again."),
      actions: [
        cancel,
        confirm
      ],
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ChangeUserInfo(user: widget.user, changeMode: "Email",)
                      )
                    );
                  },
                  child: Row(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ChangeUserInfo(user: widget.user, changeMode: "Password",)
                      )
                    );
                  },
                  child: Row(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ChangeUserInfo(user: widget.user, changeMode: "Phone",)
                      )
                    );
                  },
                  child: Row(
                ...
                InkWell(
                  onTap: () {
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        title: const Text("Account Deletion", style: TextStyle(fontSize: 20),),
                        content: const Text("Are you sure you want to delete your account? By pressing confirm you will not be able to restore your account again.", style: TextStyle(color: Colors.grey),),
                        actions: [
                          TextButton(
                            onPressed: () {
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.05, top: MediaQuery.of(context).size.height * 0.04),
                        child: const Text("Delete Account", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.redAccent),)
                      ),
                      Container(
                        margin: EdgeInsets.only(right: MediaQuery.of(context).size.width * 0.05, top: MediaQuery.of(context).size.height * 0.03),
                        child: const Row(
                          children: [
                            Icon(Icons.arrow_right_sharp, size: 25, color: Colors.redAccent,)
                          ],
                        )
                      ),
                    ],
