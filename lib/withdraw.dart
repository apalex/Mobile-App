              ...
              child: Padding(
                ...
                child: Form(
                    ...
                    child: Column(
                      children: [
                        const Text(
                          "Minimum Withdrawable amount is 10 USDT",
                          ...
                          child: TextButton(
                              onPressed: () async {
                                if (formKey.currentState!.validate()) {
                                  ...
                                  if (double.parse(withdrawalAmt.text
                                          .replaceAll(",", "")) >
                                      usdt.coinAmt) {
                                    setState(() {
                                      isVisible = true;
                                    ...
                                    await db
                                        .editCoinPortfolio(
                                            ...
                                            'tether',
                                            usdt.coinAmt -
                                                double.parse(withdrawalAmt.text
                                                    .replaceAll(",", "")))
                                        .whenComplete(() async {
                                      UserBalance balance = await db
                                          .getUserBalance(widget.user?.userId);
                                      await db
                                          .insertDepositBalance(
                                              widget.user?.userId,
                                              balance.userBalance -
                                                  double.parse(withdrawalAmt
                                                      .text
                                                      .replaceAll(",", "")))
                                          .whenComplete(() async {
                                        await db
