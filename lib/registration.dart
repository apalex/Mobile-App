                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: const EdgeInsets.only(
                              left: 4, right: 4, bottom: 10, top: 15),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            color: Colors.white,
                          ),
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: TextStyle(
                                  color: focusNodeConfirm.hasFocus
                                      ? Colors.black
                                      : Colors.black),
                              border: InputBorder.none,
                              icon: const Icon(Icons.lock),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    color: focusNodeReferral.hasFocus
                                        ? Colors.black
                                        : Colors.black),
                                border: InputBorder.none,
                        ...
                        Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 10, vertical: 4),
                          margin: const EdgeInsets.only(
                              left: 4, right: 4, bottom: 15, top: 5),
                          child: GestureDetector(
                            onTap: () {
                              setState(() {
                                isAgree = !isAgree;
                            ...
                            child: Row(
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(
                                    text:
                                        'By creating an account, I agree to Mintless\'\n',
                                    style: TextStyle(
                                      color: isAgreeColor
                                          ? Colors.black
                                          : Colors.redAccent,
